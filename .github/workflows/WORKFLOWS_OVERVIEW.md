...
- Artifacts prefixed with `clearminutes-test-`
...
```
clearminutes-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `clearminutes-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `clearminutes-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `clearminutes-macos-aarch64-release-0.1.3`
