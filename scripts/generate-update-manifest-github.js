...
console.log(`GitHub Repository: spencer-at-axiom/meetfree`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/spencer-at-axiom/meetfree/releases/download/${versionDir}/${filename}`;
...
console.log(`   curl https://github.com/spencer-at-axiom/meetfree/releases/latest/download/latest.json`);
