...
console.log(`GitHub Repository: jgibbarduk/clearminutes`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/jgibbarduk/clearminutes/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/jgibbarduk/clearminutes/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/jgibbarduk/clearminutes/releases/latest/download/latest.json`);
