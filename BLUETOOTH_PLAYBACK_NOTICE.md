...
When **reviewing recordings** in Clearminutes, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Clearminutes records at 48kHz** (professional audio standard)
...
**A**: This is a macOS/Bluetooth limitation, not a Clearminutes bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Clearminutes now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Clearminutes v0.0.5+ on macOS
