...
export default function AnalyticsConsentSwitch() {
  ...
  const handlePrivacyPolicyClick = async () => {
    try {
      await invoke('external_url_open', { url: 'https://github.com/spencer-at-axiom/meetfree/blob/main/PRIVACY_POLICY.md' });
    } catch (error) {
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Help us improve MeetFree by sharing anonymous usage data. No personal content is collected—everything stays on your device.
          </p>
        </div>
