...
/// - macOS: ~/Library/Application Support/Clearminutes/templates/
/// - Windows: %APPDATA%\Clearminutes\templates\
/// - Linux: ~/.config/Clearminutes/templates/
fn get_custom_templates_dir() -> Option<PathBuf> {
    let mut path = dirs::data_dir()?;
    path.push("Clearminutes");
    path.push("templates");
    Some(path)
}
