...
// Global language preference storage. Defaults to Korean for the Cohere build.
static LANGUAGE_PREFERENCE: std::sync::LazyLock<StdMutex<String>> =
    std::sync::LazyLock::new(|| StdMutex::new(config::DEFAULT_LANGUAGE.to_string()));
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cohere_engine::commands::open_models_folder,
            // Onboarding commands
