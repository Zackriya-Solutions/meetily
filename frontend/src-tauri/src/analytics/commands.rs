// Analytics commands - no-op stubs (PostHog telemetry removed for privacy)
...
#[command]
pub async fn track_summary_generation_completed(_model_provider: String, _model_name: String, _success: bool, _duration_seconds: Option<u64>, _error_message: Option<String>) -> Result<(), String> {
    Ok(())
}
