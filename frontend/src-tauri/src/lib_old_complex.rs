...
// PostHog analytics removed for privacy - analytics module now provides no-op stubs
...
// ANALYTICS_CLIENT removed - PostHog telemetry eliminated for privacy
...
// Analytics commands - PostHog telemetry removed for privacy
// All analytics functions are now no-ops provided by analytics::commands module
