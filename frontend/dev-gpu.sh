#!/bin/bash
# GPU-accelerated development script for Clearminutes
...
echo -e "${BLUE}🚀 Clearminutes GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting Clearminutes in development mode...${NC}"
echo ""
