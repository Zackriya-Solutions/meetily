    ...
    <div className='flex flex-col gap-4'>
      <div className="bg-white dark:bg-card rounded-lg border border-gray-200 dark:border-border p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-2">Auto Summary</h3>
            <p className="text-sm text-gray-600 dark:text-muted-foreground">Auto Generating summary after meeting completion(Stopping)</p>
          </div>
      ...
      <div className="bg-white dark:bg-card rounded-lg border border-gray-200 dark:border-border p-6 shadow-sm">
        <h3 className="text-lg font-semibold dark:text-foreground mb-4">Summary Model Configuration</h3>
