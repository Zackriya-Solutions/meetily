      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 border-b">
            <h3 className="text-xl font-semibold text-gray-900">환경 설정</h3>
            <button
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="border-t pt-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">AI 모델 구성</h4>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      <option value="builtin-ai">내장 AI</option>
                ...
                {modelConfig.provider === 'ollama' && (
                  <div>
                    <h4 className="text-lg font-bold mb-4">사용 가능한 Ollama 모델</h4>
                    {error && (
                    ...
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        ...
                        >
                          ...
                          <p className="text-gray-600">크기: {model.size}</p>
                          <p className="text-gray-600">수정됨: {model.modified}</p>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={() => {
                const micDevice = selectedDevices.micDevice || '기본값';
                const systemDevice = selectedDevices.systemDevice || '기본값';
                toast.success("장치가 선택되었습니다", {
        ...
        <div className="bg-white rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="p-6 pt-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700">신뢰도 표시 사용</p>
                <p className="text-xs text-gray-500">전사 신뢰도 품질을 색상 점으로 표시합니다</p>
              </div>
            </div>
